...
_default_en = {
    ...
    "Audio Delay -0.1s": "Audio Delay -0.1s",
    "Audio Delay +0.1s": "Audio Delay +0.1s",
    "Reset Audio Delay": "Reset Audio Delay",
    "Audio Delay: Reset": "Audio Delay: Reset",
    "Audio Delay: {}s": "Audio Delay: {}s",
    "Playback Speed": "Playback Speed",
    "Playback Settings": "Playback Settings",
    "Include Audio in Imports": "Include Audio in Imports",
    "Restore Session on Startup": "Restore Session on Startup",
    "Audio Delay": "Audio Delay",
    "Clear Resume Positions && Delays...": "Clear Resume Positions && Delays...",
    "Clear Resume Positions && Delays": "Clear Resume Positions && Delays",
    "This will erase all saved resume positions and per-file subtitle/audio delays. Continue?": "This will erase all saved resume positions and per-file subtitle/audio delays. Continue?",
    "Playback history cleared": "Playback history cleared",
    "Clear Downloaded Subtitles Cache...": "Clear Downloaded Subtitles Cache...",
    "Clear Downloaded Subtitles Cache": "Clear Downloaded Subtitles Cache",
    "This will delete all subtitle files downloaded from OpenSubtitles. Continue?": "This will delete all subtitle files downloaded from OpenSubtitles. Continue?",
    "Downloaded subtitles cache cleared": "Downloaded subtitles cache cleared",
    "Download from OpenSubtitles": "Download from OpenSubtitles",
    ...
    "On": "On",
    "Off": "Off",
    "Include audio files in imports: {}": "Include audio files in imports: {}",
    ...
    "Save to default folder without asking": "Save to default folder without asking",
    "Image Format": "Image Format",
    "Content": "Content",
    "Video image only": "Video image only",
    "Video image + subtitles": "Video image + subtitles",
    "Window as shown": "Window as shown",
